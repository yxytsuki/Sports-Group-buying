...
function initRuntimeSocketService() {
  const hosts = "192.168.137.1,192.168.1.6,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_OKuKER";
...
InterceptorManager$2.prototype.use = function use(fulfilled, rejected) {
  this.handlers.push({
    fulfilled,
    rejected
  });
...
var createError$1 = function createError(message, config, code, request3, response) {
  var error = new Error(message);
  return enhanceError2(error, config, code, request3, response);
};
  ...
  xhr = function xhrAdapter(config) {
    return new Promise(function dispatchXhrRequest(resolve2, reject) {
      ...
      request3.onabort = function handleAbort() {
        ...
        reject(createError3("Request aborted", config, "ECONNABORTED", request3));
        request3 = null;
      };
      request3.onerror = function handleError2() {
        reject(createError3("Network Error", config, null, request3));
        request3 = null;
      };
...
var mergeConfig$2 = function mergeConfig(config1, config2) {
  ...
  utils$4.forEach(mergeDeepPropertiesKeys, function mergeDeepProperties(prop) {
    if (utils$4.isObject(config2[prop])) {
      config[prop] = utils$4.deepMerge(config1[prop], config2[prop]);
    } else if (typeof config2[prop] !== "undefined") {
      config[prop] = config2[prop];
    } else if (utils$4.isObject(config1[prop])) {
      config[prop] = utils$4.deepMerge(config1[prop]);
  ...
  utils$4.forEach(otherKeys, function otherKeysDefaultToConfig2(prop) {
    if (typeof config2[prop] !== "undefined") {
      config[prop] = config2[prop];
    } else if (typeof config1[prop] !== "undefined") {
      config[prop] = config1[prop];
...
var axiosUtils$2 = utils$2;
var buildURL2 = axiosUtils$2.buildURL;
var settle2 = axiosUtils$2.settle;
var adapters = function uniAdapter(config) {
  return new Promise(function adapterUniRequest(resolve2, reject) {
    index.request({
      method: config.method.toUpperCase(),
      url: buildURL2(config.url, config.params, config.paramsSerializer),
...
var axiosUtils$1 = utils$2;
var Axios = axiosUtils$1.Axios;
var utils$1 = axiosUtils$1.utils;
var InterceptorManager = axiosUtils$1.InterceptorManager;
function UniAxios$1(defaultConfig) {
  Axios.call(this, defaultConfig);
  this.interceptors.first = new InterceptorManager();
  this.interceptors.last = new InterceptorManager();
}
UniAxios$1.prototype.request = function request2(config) {
  if (typeof config === "string") {
    config = arguments[1] || {};
    config.url = arguments[0];
  } else {
...
utils$1.forEach(["get", "delete", "connect", "head", "options", "trace"], function forEachMethodNoData3(method) {
  UniAxios$1.prototype[method] = function(url, config) {
...
utils$1.forEach(["post", "put"], function forEachMethodWithData3(method) {
  UniAxios$1.prototype[method] = function(url, data, config) {
    return this.request(utils$1.merge(config || {}, {
      method,
      url,
      data
...
var UniAxios_1 = UniAxios$1;
var axiosUtils = utils$2;
var utils = axiosUtils.utils;
var bind2 = axiosUtils.bind;
var mergeConfig2 = axiosUtils.mergeConfig;
var defaults = defaults_1;
var UniAxios = UniAxios_1;
function createInstance(defaultConfig) {
  var context = new UniAxios(defaultConfig);
  var instance = bind2(UniAxios.prototype.request, context);
  utils.extend(instance, UniAxios.prototype, context);
  utils.extend(instance, context);
  return instance;
}
var axios$1 = createInstance(defaults);
axios$1.Axios = UniAxios;
axios$1.create = function create(instanceConfig) {
  return createInstance(mergeConfig2(axios$1.defaults, instanceConfig));
};
uniAxios$1.exports = axios$1;
uniAxios$1.exports.default = axios$1;
var uniAxiosExports = uniAxios$1.exports;
var uniAxios = uniAxiosExports;
const axios = /* @__PURE__ */ getDefaultExportFromCjs(uniAxios);
